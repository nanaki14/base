...
var _jquery3 = __webpack_require__(329);
...
var g = {
  ...
  winT: function winT() {
    return (0, _jquery2.default)(window).scrollTop();
  },
  point: 768
};
...
Common = {
  ...
  smoothScroll: function smoothScroll() {
    ...
    (0, _jquery2.default)('a[href^="#"]').click(function () {
      (0, _jquery2.default)('html,body').animate({ scrollTop: (0, _jquery2.default)((0, _jquery2.default)(this).attr('href')).offset().top }, '600', '');
      return false;
    });
  },
  share: function share() {
    var shareTitle = encodeURI((0, _jquery2.default)('title').html());
    var shareUrl = encodeURI(document.URL);
    var shareUrlComponent = encodeURIComponent(document.URL);
    (0, _jquery2.default)('.js-twitterShare').attr("href", "http://twitter.com/share?url=" + shareUrl + "&text=" + shareTitle);
    (0, _jquery2.default)('.js-facebookShare').attr("href", "http://www.facebook.com/sharer.php?u=" + shareUrl + "&t=" + shareTitle);
    (0, _jquery2.default)('.js-lineShare').attr("href", "http://line.me/R/msg/text/?" + shareUrl);
    (0, _jquery2.default)('.js-pocketShare').attr("href", "http://getpocket.com/edit?url=" + shareUrl + "&title=" + shareTitle);
  }
...
(function (factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(124)], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($) {
			return factory($);
		}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
